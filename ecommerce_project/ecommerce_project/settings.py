...
# ضبط Celery لاستخدام Redis
CELERY_BROKER_URL = "redis://localhost:6379/0"  # رابط الـ Broker
CELERY_RESULT_BACKEND = "redis://localhost:6379/0"  # رابط Backend لحفظ النتائج
